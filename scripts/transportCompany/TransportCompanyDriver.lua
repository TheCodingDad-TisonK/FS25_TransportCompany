...
function TransportCompanyDriver:writeStream(streamId)
    ...
    streamWriteFloat32(streamId, self.weeklyWage or TransportCompanyDriver.BASE_WEEKLY_WAGE)
    streamWriteFloat32(streamId, self.experience or 0)
...
function TransportCompanyDriver.readStream(streamId)
    ...
    self.weeklyWage = streamReadFloat32(streamId)
    self.experience = streamReadFloat32(streamId)
